...
public class Voter {
    ...
    public static void main(String[] args) throws Exception {
       ...
       // byte[] nam=sc.nextLine().getBytes();
        inputChar = "Generate," + portNumber + ",";// + rs.encrypt(pub, name);
        
        message = inputChar.getBytes();
   ...
   //     System.out.println(enc);
       // byte[] result = concat(message, enc);
        ...
        while(true) {
            ...
            if(inputChar.equals("4")){
            ...
            else if(inputChar.equals("1")) {

                inputChar = "View," + portNumber;
                cipher.init(Cipher.ENCRYPT_MODE, public_CLA);

                byte [] view= cipher.doFinal(inputChar.getBytes("UTF-8"));
                ...
                do {
                    ...
                    if(k != 0)
                        System.out.println("\nInvalid Person Number. Please enter a person number between 1 and 6.\n");
                ...
                inputChar = "Vote," + portNumber + "," + voterID + "," + aux;
                message = inputChar.getBytes();
            ...
            else if(inputChar.equals("3")) {

                inputChar = "VotersInfo," + portNumber;
                message = inputChar.getBytes();
            //    cipher.init(Cipher.ENCRYPT_MODE, public_CTF);
                // byte [] voterInfo= cipher.doFinal(inputChar.getBytes("UTF-8"));
